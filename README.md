...
For the transmission to be made by button(BOOT), *static TxEventType_t EventType = TX_ON_EVENT;* on line 157. Then PB13 pin will be intialized. See HAL_GPIO_EXTI_Callback(). 
